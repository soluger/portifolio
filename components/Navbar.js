                ...
                <div className="sm:flex sm:items-center px-6 py-4 pt-5 sm:pt-4">
                    ...
                    <div className="text-center sm:text-left sm:flex-grow">
                        ...
                        <button onClick={()=>setTabs("home")} className="bg-transparent border border-gray-500 hover:border-green-500 text-xs text-gray-500 hover:text-green-500 font-bold py-1 px-4 rounded-full">About</button>
                            ...
                            <button onClick={()=>setTabs("projetos")} className="bg-transparent border border-gray-500 ml-2 hover:border-green-500 text-xs text-gray-500 hover:text-green-500 font-bold py-1 px-4 rounded-full">Projetos</button>
                            <button onClick={()=>setTabs("cursos")} className="bg-transparent border border-gray-500 ml-2 hover:border-green-500 text-xs text-gray-500 hover:text-green-500 font-bold py-1 px-4 rounded-full">Cursos</button>
                        </div>                    
                    </div>
                </div>
